...
const RegistroEdicionProyecto = ()=>{
    ...
    return(
        <div className="container mt-4">
            <div className="row">
            <div className="col-4 fs-5 bg-primary text-light">Registrar/Editar Proyecto</div>
            </div>
            <div className="row border boder-primary">
                <div className="col-12">
                    <form className="row g-3 mt-3">
                        ...
                        <div className="col-md-8 mx-auto">
                            <label for="inputSite" className="form-label">Jefe Proyecto</label>
                            <select id="inputSite" className="form-select">
                                <option selected>Select...</option>
                                <option>...</option>
                            </select>
            ...
            <div className="col-10 d-flex justify-content-end mb-4">
                    <form className="row g-3 mt-3">
                        ...
                        <div className="col-md-2 mx-auto">
                             <Link type="submit" className="btn btn-danger" to="/listado-proyectos">Cancelar</Link>
                        </div>
                    </form>
            </div>            
...
export default RegistroEdicionProyecto ;