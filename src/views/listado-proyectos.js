      ...
      <div className="row mt-4">
        <div className="col-md-12 d-flex justify-content-end">
          <Link
            ...
            to="/listado-proyectos/registro-edicion-proyecto"
          >
            Agregar Proyecto
          </Link>
        </div>
            ...
            proyectos.map((proyecto, index) => {
              return (
                <tr key={index}>
                  ...
                  <td>
                    <button className="edit-icon border-white bg-transparent text-primary">
                      {" "}
                      <i class="fas fa-database"></i>{" "}
                    </button>
                    <Link
                      className="edit-icon border-white bg-transparent text-success"
                      to="/"
                    >
                      <i className="far fa-edit "></i>{" "}
                    </Link>
                    <button className="trash-icon border-white bg-transparent text-danger">
